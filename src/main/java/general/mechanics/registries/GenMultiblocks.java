...
public class GenMultiblocks {
	...
	public static final MultiblockDefinition ELECTRIC_FURNACE = register("Furnace Factory", Multiblock.builder(MultiblockPattern.builder().whereHatchable('B', MultiblockElement.block(GenBlocks.MACHINE_FRAME)).where('C', MultiblockElement.block(GenBlocks.ELECTRIC_FURNACE)).whereUniform('U', CoreTags.Blocks.CORE_MATRICES, GenBlocks.IRON_CORE_MATRIX).where('I', MultiblockElement.block(GenBlocks.HEATING_ELEMENT)).whereHatchable('T', GenBlocks.MACHINE_CASING).anchor('C').layer("BBB", "BBB", "BCB").layer("UUU", "UIU", "UUU").layer("UUU", "UIU", "UUU").layer("UUU", "UIU", "UUU").layer("TTT", "TTT", "TTT").build()).hatch(MultiblockHatchDefinition.builder("item_input", GenBlocks.ITEM_INPUT_HATCH).count(1).itemInsert(ElectricFurnaceBlock.RecipeSlots.INPUT, ElectricFurnaceBlock.RecipeSlots.CATALYST).build()).hatch(MultiblockHatchDefinition.builder("item_output", GenBlocks.ITEM_OUTPUT_HATCH).count(1).itemExtract(ElectricFurnaceBlock.RecipeSlots.OUTPUT_1, ElectricFurnaceBlock.RecipeSlots.OUTPUT_2, ElectricFurnaceBlock.RecipeSlots.OUTPUT_3, ElectricFurnaceBlock.RecipeSlots.OUTPUT_4).build()).hatch(MultiblockHatchDefinition.builder("energy", GenBlocks.POWER_HATCH).count(1).energy(ResourceIoMode.INSERT).build()).hatch(MultiblockHatchDefinition.builder("network", GenBlocks.NETWORK_HATCH).count(HatchCount.atMost(1)).itemInsert(ElectricFurnaceBlock.RecipeSlots.INPUT).itemInsert(ElectricFurnaceBlock.RecipeSlots.CATALYST).itemExtract(ElectricFurnaceBlock.RecipeSlots.OUTPUT_1, ElectricFurnaceBlock.RecipeSlots.OUTPUT_2, ElectricFurnaceBlock.RecipeSlots.OUTPUT_3, ElectricFurnaceBlock.RecipeSlots.OUTPUT_4).network(NetworkServices.ITEM, NetworkServices.ENERGY, NetworkServices.DATA).build()).build());
