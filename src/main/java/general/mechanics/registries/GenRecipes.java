...
public final class GenRecipes {
	...
	public static final MachineRecipeDefinition<NoRecipeData> COKE_OVEN = REGISTRY.register("coke_oven", MachineRecipeSchema.builder().itemInput("input").itemOutput("output").fluidOutput("creosote").build()).craftingStation(() -> GenBlocks.COKE_OVEN_CONTROLLER);
