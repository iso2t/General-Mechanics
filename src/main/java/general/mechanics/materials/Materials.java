...
public final class Materials {
	...
	/** Eager, registry-independent view of each material's forms — readable at item-registration time. */
	private static final Map<ResourceKey<Material>, Set<ItemForm>> FORMS_BY_KEY = new HashMap<>();
	...
	public static final ResourceKey<Material> POLYETHYLENE = register("Polyethylene", (b, l) -> b
			...
			.color(0xFFD0D0D0), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE));
	...
	// Rubbers
	public static final ResourceKey<Material> ISOPRENE = register("Isoprene", (b, l) -> b
			.category(l.category(FormulaCategories.POLYMER))
			.formula(Formula.builder().atom(l.atom(FormulaAtoms.CARBON), 5).atom(l.atom(FormulaAtoms.HYDROGEN), 8))
			.trait(l.trait(FormulaTraits.INSULATING))
			.color(0xFFD0D0D0), List.of());
	...
	public static final ResourceKey<Material> WATER = register("Water", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.ORGANIC)), List.of());
	...
	public static final ResourceKey<Material> STEEL = register("Steel", (b, l) -> b
			...
			.color(0xFF8C8C9C), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> IRON = register("Iron", (b, l) -> b
			...
			.color(0xFFD8D8D8), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> ALUMINIUM = register("Aluminium", (b, l) -> b
			...
			.color(0xFFD0D2D5), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> TITANIUM = register("Titanium", (b, l) -> b
			...
			.color(0xFFB0B5BA), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> TUNGSTEN = register("Tungsten", (b, l) -> b
			...
			.color(0xFF6F7378), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> COBALT = register("Cobalt", (b, l) -> b
			...
			.color(0xFF4A6FB0), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> LEAD = register("Lead", (b, l) -> b
			...
			.color(0xFF575E66), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> SILVER = register("Silver", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.CONDUCTIVE))
			.color(0xFFE8E8EE), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> PLATINUM = register("Platinum", (b, l) -> b
			...
			.color(0xFFE5E4DF), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> CHROMIUM = register("Chromium", (b, l) -> b
			...
			.color(0xFFC6CDD2), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> MANGANESE = register("Manganese", (b, l) -> b
			...
			.color(0xFF9C9AA0), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> MAGNESIUM = register("Magnesium", (b, l) -> b
			...
			.color(0xFFCFCFC9), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> LITHIUM = register("Lithium", (b, l) -> b
			...
			.color(0xFFB8BBC0), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> URANIUM = register("Uranium", (b, l) -> b
			...
			.color(0xFF5E7042), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.RAW, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> BRONZE = register("Bronze", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.STRUCTURAL)).trait(l.trait(FormulaTraits.CONDUCTIVE))
			.color(0xFFCD7F32), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> BRASS = register("Brass", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.STRUCTURAL)).trait(l.trait(FormulaTraits.CONDUCTIVE))
			.color(0xFFD1B642), ItemForm.getDefaultFormsAndGear());
	...
	public static final ResourceKey<Material> ELECTRUM = register("Electrum", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.CONDUCTIVE))
			.color(0xFFE8D98A), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> INVAR = register("Invar", (b, l) -> b
			...
			.color(0xFF9AA0A6), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> CONSTANTAN = register("Constantan", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.CONDUCTIVE))
			.color(0xFFB08D6A), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> CUPRONICKEL = register("Cupronickel", (b, l) -> b
			...
			.color(0xFFC2A98E), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> SOLDER = register("Solder", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.CONDUCTIVE))
			.color(0xFFB7BDC2), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.ROD, ItemForm.PILE));
	...
	public static final ResourceKey<Material> NICHROME = register("Nichrome", (b, l) -> b
			...
			.trait(l.trait(FormulaTraits.CONDUCTIVE)).trait(l.trait(FormulaTraits.STRUCTURAL))
			.color(0xFF8E8E94), List.of(ItemForm.DUST, ItemForm.INGOT, ItemForm.NUGGET, ItemForm.PLATE, ItemForm.ROD, ItemForm.PILE));

	/**
	 * Declares a material: creates its {@link ResourceKey} (path derived from {@code name}), records the
	 * recipe for {@link #bootstrap(BootstrapContext)}, and captures its {@code forms} eagerly so they can
	 * be queried via {@link #getDefaultForms(ResourceKey)} at item-registration time (before the datapack
	 * registry that holds the built {@link Material} exists).
	 */
	private static ResourceKey<Material> register (String name, MaterialFactory factory, List<ItemForm> forms) {
		var key = ResourceKey.create(GenFormula.MATERIAL_REGISTRY, Resource.get(name.toLowerCase().replace(' ', '_')));
		Set<ItemForm> formSet = forms.isEmpty() ? EnumSet.noneOf(ItemForm.class) : EnumSet.copyOf(forms);
		ENTRIES.add(new Entry(name, key, factory, formSet));
		FORMS_BY_KEY.put(key, formSet);
		return key;
	}

	/**
	 * The item forms a material supports, available eagerly (independent of the datapack registry).
	 * Returns an empty set for unknown keys.
	 */
	public static Set<ItemForm> getDefaultForms (ResourceKey<Material> key) {
		return FORMS_BY_KEY.getOrDefault(key, Set.of());
	}
	...
	public static void bootstrap (BootstrapContext<Material> ctx) {
		...
		for (Entry entry : ENTRIES) {
			...
			builder.form(entry.forms().toArray(ItemForm[]::new));
			ctx.register(entry.key(), builder.build());
		}
	}

	private record Entry(String name, ResourceKey<Material> key, MaterialFactory factory, Set<ItemForm> forms) {}
