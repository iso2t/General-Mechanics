...
public class DatapackProvider extends DatapackBuiltinEntriesProvider {
	...
	public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder().add(Registries.DAMAGE_TYPE, GenDamageTypes::bootstrap).add(Registries.CONFIGURED_FEATURE, GenFeatures::bootstrap).add(Registries.PLACED_FEATURE, GenFeatures::placedFeatures).add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, GenFeatures::biomeModifiers);
