...
public final class FormulaCategories {
	...
	public static final ResourceKey<Category> ALKALI_METAL    = GenFormula.categoryKey("alkali_metal");
	public static final ResourceKey<Category> ALKALINE_EARTH_METAL = GenFormula.categoryKey("alkaline_earth_metal");
